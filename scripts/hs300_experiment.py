...
- 信号名 ashare_mlp_signal_v15_hs300（不覆盖生产信号）

用法:
  /home/airst/Workspace/.venv/bin/python scripts/hs300_experiment.py
"""
import sys, os
...
SIGNAL = "ashare_mlp_signal_v15_hs300"
...
def main():
    ...
    for n in [5, 10]:
        ...
        print(f"  2026月度: {line}")
        with open(f"log/hs300_experiment_n{n}.json", "w") as f:
